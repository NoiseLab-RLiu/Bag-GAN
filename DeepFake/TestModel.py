#This is a model for us to test our network, if you want check our result, please go to the Demonstration.ipynb
#Before using this model, make sure you've downloaded the datasets, i.e. there exists a ./datasets folder
#If you want to download the datasets, please run the DownloadDataset.py
